            ...
            <div v-if="posts.data.length > 0">
                ...
                >
                    ...
                    <inertia-link
                        ...
                        >Edit Product</inertia-link
                    >
                    <a
                        href="javascript:void(0);"
                        class="btn btn-warning pull-right action-btn"
                        @click.prevent="deletePost(post.id)"
                        ><i class="fas fa-trash-alt"></i> Delete Product</a
                    >
                </div>
                ...
                >
                    <ul class="pagination">
                        ...
                        <li
                            :class="
                                'page-item' +
                                (posts.links[0].url == null ? ' disabled' : '')
                            "
                        >
                            <inertia-link
                                :href="
                                    posts.links[0].url == null
                                        ? '#'
                                        : posts.links[0].url
                                "
                                class="page-link"
                        ...
                        >
                            <inertia-link
                                ...
                                class="page-link"
                                v-html="
                                    posts.links[posts.links.length - 1].label
                                "
                            ></inertia-link>
                        </li>
                    </ul>
