        ...
        <div class="col-md-6 offset-md-3">
            <form method="post" @submit.prevent="submit">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  id="productname" name="productname" class="form-control" v-model="form.productname"/>
                </div>

                <div class="form-group">
                    <label for="sku">sku</label>
                    <input type="text" class="form-control" name="sku" id="sku" v-model="form.sku" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  id="tax" name="tax" class="form-control" v-model="form.tax"/>
                </div>
                <div class="form-group">
...
export default {
    ...
    setup() {
        ...
        // retrieve post prop
        const {upc, productname, sku, Price, tax, image_url, id } = usePage().props.value.post;
        form.upc = upc;
