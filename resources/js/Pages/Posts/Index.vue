            ...
            <div class="col-md-12" style="margin-top: 20px">
                ...
                <div v-if="posts.data.length > 0">
                    ...
                    <div class="col-md-10 article" v-for="post in posts.data" :key="post.id">
                        ...
                        <inertia-link :href="$route('post.edit', {id: post.id})" class="btn btn-primary pull-right action-btn">Edit Product</inertia-link>
                        <a href="javascript:void(0);" class="btn btn-warning pull-right action-btn" @click.prevent="deletePost(post.id)"><i class="fas fa-trash-alt"></i> Delete Product</a>
                    </div>
